...
import img from "../img/fullsize/logo.jpg";
  ...
  return (
    <div className="px-4  mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      <div className="relative flex items-center justify-between">
        ...
        >
          <img src={img} alt="logo" className="w-16 h-16 mr-2 rounded-full" />

          <span className="ml-2 text-xl font-bold tracking-wide  ">Misk</span>
        </Link>
        ...
        <div className="lg:hidden">
          ...
          {isMenuOpen && (
            <div className="top-10 left-10 w-full">
