      ...
      <div className="container px-6 py-24 mx-auto lg:py-32">
        ...
        >
          <div className="lg:w-1/2">
            ...
            <h1 className="mt-4 text-3xl font-medium text-blue-500 capitalize md:text-4xl lg:text-5xl ">
          ...
          <div className="mt-8 lg:w-1/2 lg:mt-0">
            <form className="w-full lg:max-w-xl">
              ...
              <div className="mt-8 md:flex md:items-center">
                <button className="w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-500 rounded-md md:w-1/2 hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                  Sign in
                </button>
